...
test_that("Null input is handled", {
    ...
    # null input.
  expect_true(checkPublicSuffix(NA, NA))
})
...
#  expect_true(checkPublicSuffix('.com', NA))
#  expect_true(checkPublicSuffix('.example', NA))
#  expect_true(checkPublicSuffix('.example.com', NA))
#  expect_true(checkPublicSuffix('.example.example', NA))
#})
...
test_that("Listed, but non-Internet, TLD.", {
  expect_true(checkPublicSuffix('local', NA))
  expect_true(checkPublicSuffix('example.local', NA))
  expect_true(checkPublicSuffix('b.example.local', NA))
  expect_true(checkPublicSuffix('a.b.example.local', NA))
})

test_that("TLD with only 1 rule.", {
  #expect_true(checkPublicSuffix('biz', NA))
...
test_that("TLD with some 2-level rules.", {
  ...
  #expect_true(checkPublicSuffix('uk.com', NA))
...
test_that("TLD with a wildcard rule and exceptions.", {
  #expect_true(checkPublicSuffix('ck', NA))
  #expect_true(checkPublicSuffix('test.ck', NA))
...
test_that("IDN labels.", {
  ...
  #expect_true(checkPublicSuffix('公司.cn', NA))
  ...
  #expect_true(checkPublicSuffix('中国', NA))
})
...
test_that("Same as above, but punycoded.", {
  ...
  #expect_true(checkPublicSuffix('xn--55qx5d.cn', NA))
  ...
  #expect_true(checkPublicSuffix('xn--fiqs8s', NA))  
})
